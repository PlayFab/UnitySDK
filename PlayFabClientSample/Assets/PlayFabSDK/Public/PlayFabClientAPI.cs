...
namespace PlayFab
{
	...
	public class PlayFabClientAPI
	{
		...
		/// </summary>
		public static void LoginWithCustomID(LoginWithCustomIDRequest request, LoginWithCustomIDCallback resultCallback, ErrorCallback errorCallback)
		{
			request.TitleId = PlayFabSettings.TitleId ?? request.TitleId;
			if(request.TitleId == null) throw new Exception ("Must be have PlayFabSettings.TitleId set to call this method");
		...
		/// </summary>
		public static void LinkCustomID(LinkCustomIDRequest request, LinkCustomIDCallback resultCallback, ErrorCallback errorCallback)
		{
			if (AuthKey == null) throw new Exception ("Must be logged in to call this method");
			...
			Action<string,string> callback = delegate(string responseStr, string errorStr)
			{
				...
				PlayFabError error = null;
				ResultContainer<LinkCustomIDResult>.HandleResults(responseStr, errorStr, out result, out error);
				if(error != null && errorCallback != null)
				{
					errorCallback(error);
				}
		...
		/// </summary>
		public static void UnlinkCustomID(UnlinkCustomIDRequest request, UnlinkCustomIDCallback resultCallback, ErrorCallback errorCallback)
		{
			if (AuthKey == null) throw new Exception ("Must be logged in to call this method");
			...
			Action<string,string> callback = delegate(string responseStr, string errorStr)
			{
				...
				PlayFabError error = null;
				ResultContainer<UnlinkCustomIDResult>.HandleResults(responseStr, errorStr, out result, out error);
				if(error != null && errorCallback != null)
				{
					errorCallback(error);
				}
