...
namespace PlayFab.UUnit
{
    ...
    public static class PlayFabUUnitUtils
    {
        ...
        /// <summary>
        /// Test-wrapper callback for Simple, non PlayFab error backed API-Callbacks without any parameters.
        /// If there are unhandled exceptions in those tests, make sure it gets reported to the test as a failure
        /// This is ONLY meant to be used by the PlayFab UUnit test framework
        /// </summary>
        public static Action SimpleApiNoParamsActionWrapper(UUnitTestContext testContext, Action<UUnitTestContext> myfunc)
        {
            Action subWrapper = () =>
            {
                try
