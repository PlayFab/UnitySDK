...
namespace PlayFab
{
    ...
    public static class PlayFabAddonAPI
    {
        ...
        /// </summary>
        public static void ConfigurePSNEventStreams(ConfigurePSNEventStreamsRequest request, Action<ConfigurePSNEventStreamsResponse> resultCallback, Action<PlayFabError> errorCallback, object customData = null, Dictionary<string, string> extraHeaders = null)
        {
            ...
            PlayFabHttp.MakeApiCall("/Addon/ConfigurePSNEventStreams", request, AuthType.EntityToken, resultCallback, errorCallback, customData, extraHeaders, context, callSettings);
        }
